...
#if CONFIG_IDF_TARGET_ESP32P4
    // ESP32-P4: no native BT controller -- BLE runs on C6 co-processor via esp_hosted vHCI
...
nimble_hid_gap_event(struct ble_gap_event *event, void *arg)
{
    ...
    case BLE_GAP_EVENT_PASSKEY_ACTION:
        ...
        if (event->passkey.params.action == BLE_SM_IOACT_DISP) {
            ...
            ESP_LOGI(TAG, ">>> PASSKEY: %06" PRIu32 " -- type this on the keyboard <<<", pkey.passkey);
